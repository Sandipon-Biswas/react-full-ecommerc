        ...
        <div>
            <section className="text-gray-600 body-font mb-10">
                ...
                <div className="container px-5 py-10 mx-auto">
                    ...
                    {/* para  */}
                    <h2 className=' text-center text-2xl font-semibold mb-10' >What our <span className=' bg-cyan-900'>customers</span> are saying</h2>
                    ...
                    <div className="flex flex-wrap -m-4">
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <span className="inline-block h-1 w-10 rounded bg-cyan-900 mt-6 mb-4" />
                                <h2 className="text-gray-500font-medium title-font tracking-wider text-sm uppercase">Kamal Nayan Upadhyay</h2>
                        ...
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <p className="leading-relaxed">Edison bulb retro cloud bread echo park, helvetica stumptown taiyaki taxidermy 90's cronut +1 kinfolk. Single-origin coffee ennui shaman taiyaki vape DIY tote bag drinking vinegar cronut adaptogen squid fanny pack vaporware.</p>
                                <span className="inline-block h-1 w-10 rounded bg-cyan-900 mt-6 mb-4" />
                                <h2 className="text-gray-500 font-medium title-font tracking-wider text-sm uppercase">S Mishra</h2>
